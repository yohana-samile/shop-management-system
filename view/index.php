        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="../user/view/">Staffs</a>
                        <?php if($_SESSION['userData']['roleName'] == 'administrator' || $_SESSION['userData']['roleName'] == 'manager'): ?>
                            <a class="collapse-item" href="../user categories/view/">User Categories</a>
                        <?php endif; ?>
                    </div>
                </div>
            </li>
            ...
            <div id="collapseSales" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                <div class="bg-white py-2 collapse-inner rounded">
                    ...
                    <a class="collapse-item" href="../product cart/view/">Products On Cart</a>
                    <a class="collapse-item" href="../product cart/view/purchasingHistory.php">Purchasing History</a>
                </div>
            </div>
            </li>
            ...
            <li class="nav-item">
                ...
                <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="../product/view/">Products Available</a>
                        <a class="collapse-item" href="../product category/view/">Product Categories</a>
                        <a class="collapse-item" href="../unit/view/">Product Units</a>
                    </div>
                </div>
            </li>
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <span class="mr-2 d-none d-lg-inline text-gray-600 small"><?php echo $_SESSION['userData']['fullName']; ?></span>
                                <?php
                                    $profile = $conn->query("SELECT passportSize FROM `user` where userId = {$_SESSION['userData']['userId']}");
                                    $result = mysqli_fetch_array($profile); 
                                ?>
                                <img class="img-profile rounded-circle" src="../upload/<?php echo $result['passportSize']; ?>">
                            </a>
